...
require.def(
    ...
    function(Device, MediaController, MediaEvent, MediaErrorEvent, MediaSourceErrorEvent, MediaSource, Application) {
        ...
        var SamsungPlayer = MediaController.extend({
            ...
            registerEventHandlers : function() {
                ...
                window.SamsungMapleOnStreamInfoReady = function () {
                    ...
                    self._eventHandlingFunction(new MediaEvent("durationchange", self));
                ...
                window.SamsungMapleOnCurrentPlayTime = function (timeMs) {
                    ...
                    if ((self.mediaSource.isLiveStream() && self.videoPlayerState.ended == false) ||
                        ...
                        if (self.videoPlayerState.seeking) {
                            ...
                            self._eventHandlingFunction(new MediaEvent('seeked', self));
                        }
            ...
            setCurrentTime: function(timeToSeekTo) {
                ...
                this._eventHandlingFunction(new MediaEvent('seeking', this));
            ...
            play: function() {
                if (this.videoPlayerState.paused) {
                    ...
                    this.videoPlayerState.paused = false;
                    this._eventHandlingFunction(new MediaEvent("play", this));
                    this._eventHandlingFunction(new MediaEvent("playing", this));
                }
            },
            stop: function() {
                this.playerPlugin.Stop();
        ...
        Device.prototype.createMediaController = function(id, mediaType, eventHandlingFunction) {
            return new SamsungPlayer(id, mediaType, eventHandlingFunction);
        };
